...
exports.getUser = exports.newUser = exports.findUserByToken = exports.findUserByEmail = void 0;
...
const findUserByToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma.user.findFirst({ where: { token } });
});
...
const getUser = (email) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma.user.findFirst({ where: { email } });
});
